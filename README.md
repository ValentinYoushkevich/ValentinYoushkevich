...
**Merged** — <!--m:count-->34<!--/m:count--> pull requests in [`vuejs/core`](https://github.com/vuejs/core/pulls?q=is%3Apr+author%3AValentinYoushkevich+is%3Amerged), all in Vapor mode:
