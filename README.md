...
| `runtime-vapor` — VDOM interop | Nested VDOM content was not unmounted; a VDOM child rooted at a slot outlet resolved to the wrong nodes; slots never reached VDOM async components; a dynamic component remounted same-type vnodes instead of patching them; `$el` and other `$` properties broke on exposed Vapor instances read from VDOM refs | [#15524](https://github.com/vuejs/core/pull/15524), [#15542](https://github.com/vuejs/core/pull/15542), [#15513](https://github.com/vuejs/core/pull/15513), [#15631](https://github.com/vuejs/core/pull/15631), [#15624](https://github.com/vuejs/core/pull/15624) |
| `runtime-vapor` — rendering | `v-for` item order broke around empty nested branches; transition classes were wiped by a class update; deferred teleport children fired update hooks on mount; bound `checked` / `selected` were not mirrored to attributes, so a form reset undid them | [#15529](https://github.com/vuejs/core/pull/15529), [#15528](https://github.com/vuejs/core/pull/15528), [#15527](https://github.com/vuejs/core/pull/15527), [#15636](https://github.com/vuejs/core/pull/15636) |
